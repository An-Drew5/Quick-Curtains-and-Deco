      ...
      <Container>
        <div className="space-y-8">
          <div className="space-y-2">
            <h1 className="font-display text-4xl text-navy sm:text-5xl">Checkout</h1>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_420px] lg:items-start">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Link href="/shop" className="text-sm font-medium text-navy hover:underline">
                  Continue shopping
                </Link>
              </div>
            </form>
            ...
            <aside className="space-y-4 rounded-3xl border border-black/5 bg-white p-6 shadow-sm sm:p-8 lg:sticky lg:top-24">
              ...
              <div className="space-y-2 border-t border-black/10 pt-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium text-ink">Calculated by backend</span>
                </div>
